...
(function($) {
    ...
    $(".bg-ytvideo").each(function() {
        ...
        $(this).data(
            ...
            "{videoURL:'https://www.youtube.com/watch?v=FFXctkSdi_s',containment:'self',autoPlay:" + vidAutoPlay + ", mute:" + vidMute + ", startAt:" + vidStartAt + ", opacity:" + vidOpacity + ",showYTLogo:" + vidShowPluginLogo + ",showControls:" + vidShowControls + ",stopMovieOnBlur:false,mobileFallbackImage:'" + vidFallBackImg + "'}"
        );
    });
